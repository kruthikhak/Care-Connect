...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'templates',
            BASE_DIR / 'healthcare_project' / 'templates',
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
FILTERS_TEMPLATE = 'django_filters/rest_framework/form.html'
...
REST_AUTH = {
    ...
    'JWT_AUTH_COOKIE': 'healthcare-auth',
    'JWT_AUTH_REFRESH_COOKIE': 'healthcare-refresh-token',
